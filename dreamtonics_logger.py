# logs all dreamtonics API traffic to .log and .json files
# useful for further reverse engineering without touching anything!
# you also REALLY shouldn't commit output from this script!!!
