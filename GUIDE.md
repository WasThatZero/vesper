...
tags - tells the UI how to render the card, there are some variations:
    ...
    web-text-download-description-v2-voice-v2-compatible - shows popup saying it has an SV1 installer, but also a native and proper SV2 version
...
pitch_range_min/pitch_range_max - min and max recommend pitches for the voice in midi numbers, see https://inspiredacoustics.com/en/MIDI_note_numbers_and_center_frequencies for a list
